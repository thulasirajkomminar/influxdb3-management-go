...
// DeleteRetentionPeriodForTableParams defines parameters for DeleteRetentionPeriodForTable.
type DeleteRetentionPeriodForTableParams struct {
	// Db The database name.
	Db string `form:"db" json:"db"`
...
// CreateOrUpdateRetentionPeriodForTableParams defines parameters for CreateOrUpdateRetentionPeriodForTable.
type CreateOrUpdateRetentionPeriodForTableParams struct {
	// Db The database name.
	Db string `form:"db" json:"db"`
...
// ConfigureFileIndexDeleteJSONRequestBody defines body for ConfigureFileIndexDelete for application/json ContentType.
type ConfigureFileIndexDeleteJSONRequestBody = FileIndexDeleteRequest

// ConfigureFileIndexCreateJSONRequestBody defines body for ConfigureFileIndexCreate for application/json ContentType.
type ConfigureFileIndexCreateJSONRequestBody = FileIndexCreateRequest

// StopNodeJSONRequestBody defines body for StopNode for application/json ContentType.
type StopNodeJSONRequestBody = StopNodeRequest
