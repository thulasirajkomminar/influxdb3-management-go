// Package enterprise provides primitives to interact with the openapi HTTP API.
//
...
type ClientInterface interface {
	...
	// PostCreateResourceToken request
	PostCreateResourceToken(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) PostCreateResourceToken(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostCreateResourceTokenRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewPostCreateResourceTokenRequest generates requests for PostCreateResourceToken
func NewPostCreateResourceTokenRequest(server string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/v3/configure/enterprise/token")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// PostCreateResourceTokenWithResponse request
	PostCreateResourceTokenWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*PostCreateResourceTokenResponse, error)
...
// PostCreateResourceTokenWithResponse request returning *PostCreateResourceTokenResponse
func (c *ClientWithResponses) PostCreateResourceTokenWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*PostCreateResourceTokenResponse, error) {
	rsp, err := c.PostCreateResourceToken(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
