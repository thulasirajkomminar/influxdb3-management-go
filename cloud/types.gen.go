// Package influxdb3cloud provides primitives to interact with the openapi HTTP API.
//
// Code generated by github.com/oapi-codegen/oapi-codegen/v2 version v2.7.1 DO NOT EDIT.
package influxdb3cloud
...
const (
	BearerAuthJwtScopes             bearerAuthJwtContextKey             = "bearerAuthJwt.Scopes"
	BearerAuthManagementTokenScopes bearerAuthManagementTokenContextKey = "bearerAuthManagementToken.Scopes"
)
...
// Valid indicates whether the value is a known member of the ClusterDatabasePartitionTemplatePartBucketType enum.
func (e ClusterDatabasePartitionTemplatePartBucketType) Valid() bool {
	switch e {
	case Bucket:
		return true
	default:
...
// Valid indicates whether the value is a known member of the ClusterDatabasePartitionTemplatePartTagValueType enum.
func (e ClusterDatabasePartitionTemplatePartTagValueType) Valid() bool {
	switch e {
	case Tag:
		return true
	default:
...
// Valid indicates whether the value is a known member of the ClusterDatabasePartitionTemplatePartTimeFormatType enum.
func (e ClusterDatabasePartitionTemplatePartTimeFormatType) Valid() bool {
	switch e {
	case Time:
		return true
	default:
...
// Valid indicates whether the value is a known member of the DatabaseTokenResourceAllDatabases enum.
func (e DatabaseTokenResourceAllDatabases) Valid() bool {
	switch e {
	case Asterisk:
		return true
	default:
...
// ClusterDatabasePartitionTemplate A template for partitioning a cluster database.
//
...
// ClusterDatabaseRetentionPeriod The retention period of the cluster database in nanoseconds, if applicable
//
...
// ClusterDatabaseTableName The name of the cluster database table
...
// DatabaseTokenExpiresAt defines model for DatabaseTokenExpiresAt.
type DatabaseTokenExpiresAt = DateTimeRfc3339

// DatabaseTokenPermission The description of the database token
type DatabaseTokenPermission struct {
	// Action The action the database token permission allows
	Action *DatabaseTokenPermissionAction `json:"action,omitempty"`

	// Resource The resource the database token permission applies to
	Resource *DatabaseTokenPermissionResource `json:"resource,omitempty"`
}

// DatabaseTokenPermissionAction The action the database token permission allows
type DatabaseTokenPermissionAction = string

// DatabaseTokenPermissionResource The resource the database token permission applies to
type DatabaseTokenPermissionResource struct {
	union json.RawMessage
}

// DatabaseTokenPermissions The list of permissions the database token allows
type DatabaseTokenPermissions = []DatabaseTokenPermission

// DatabaseTokenResourceAllDatabases A resource value for a database token permission that refers to all databases
type DatabaseTokenResourceAllDatabases string

// DatabaseTokenRevokedAt defines model for DatabaseTokenRevokedAt.
type DatabaseTokenRevokedAt = DateTimeRfc3339
...
// bearerAuthJwtContextKey is the context key for bearerAuthJwt security scheme
type bearerAuthJwtContextKey string

// bearerAuthManagementTokenContextKey is the context key for bearerAuthManagementToken security scheme
type bearerAuthManagementTokenContextKey string
...
type CreateClusterDatabaseJSONBody struct {
	...
	// PartitionTemplate A template for partitioning a cluster database.
	//
	// Each partition template part is evaluated in sequence.
	// The outputs from each part are concatenated with the
	// `|` delimiter to form the final partition key.
	...
	// RetentionPeriod The retention period of the cluster database in nanoseconds, if applicable
	//
	// If the retention period is not set or is set to 0, the database will have infinite retention
...
type CreateClusterDatabaseTableJSONBody struct {
	// Name The name of the cluster database table
...
type CreateDatabaseTokenJSONBody struct {
	...
	ExpiresAt   *DatabaseTokenExpiresAt  `json:"expiresAt,omitempty"`

	// Permissions The list of permissions the database token allows
